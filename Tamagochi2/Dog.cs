...
namespace Tamagochi2
{
    internal class Dog
    {
        ...
        public void Idle()
        {
            _pb.Image = Image.FromFile("C:\\Works\\Parkjs\\Tamagochi2\\Images\\dog_idle.gif");
        }
        public void Sleep()
        {
            _pb.Image = Image.FromFile("C:\\Works\\Parkjs\\Tamagochi2\\Images\\dog_sleep.gif");
        }
        public void Cry()
        {
            _pb.Image = Image.FromFile("C:\\Works\\Parkjs\\Tamagochi2\\Images\\dog_cry.gif");
        }
        public void Hungry()
        {
            _pb.Image = Image.FromFile("C:\\Works\\Parkjs\\Tamagochi2\\Images\\dog_hungry.gif");
        }
        public void Happy()
        {
            _pb.Image = Image.FromFile("C:\\Works\\Parkjs\\Tamagochi2\\Images\\dog_happy.gif");
        }
        public void Feed()
        {
            _pb.Image = Image.FromFile("C:\\Works\\Parkjs\\Tamagochi2\\Images\\dog_feed.gif");
        }
